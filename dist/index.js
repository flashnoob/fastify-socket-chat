...
var user_helper_1 = require("./components/users/user.helper");
var PORT = 5000;
var server = app_1.FastifyServer();
...
server.ready(function (err) {
    ...
    server.io.on('connection', function (socket) {
        ...
        socket.on('join', function (_a, callback) {
            ...
            var user = { id: socket.id, name: name, room: room };
            user_helper_1.addUser(user);
